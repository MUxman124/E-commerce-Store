<template>
    <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32 mt-16">
        <a href="#" class="text-4xl font-bold text-gray-800">CheckOut</a>
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div class="px-4 pt-8">
            ...
            <div class="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
                <CheckOutProd v-for="product in items" :key="product.id" :CartItems="product" />
...
<script setup>
import CheckOutProd from "./CheckOutProd.vue";
