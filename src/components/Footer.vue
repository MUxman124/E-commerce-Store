                ...
                <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                    <div class="mb-10 w-full">
                        ...
                        <p class="text-body-color mb-7 text-base">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum laborum optio repellat enim facere? Et ipsum atque iure modi dignissimos molestiae cupiditate debitis ducimus vitae. Possimus facere cupiditate obcaecati eos.
                        </p>
